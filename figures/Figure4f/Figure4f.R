...
for (args in args_ls) {
  ...
  write.csv(res[[args$tag]]$mtx, paste0('Fig3J.', args$tag, '.ModScores.RdBu.offset.none.csv'), row.names = TRUE)
}
...
save_grob_pdf(combined_grob, paste0('Fig3J.Arm+Cl13.ModScores.', 'offset.scale_all.pdf'), height=4, width=12)
plot(combined_grob)
