...
# Scoring different CD8+ T cell type signatures for the gRNA knockouts in the Clone 13 LCMV experiment
...
save_pheatmap_pdf(fig, 'Fig3I.Cl13.ModScores.RdBu.offset.none.pdf')
fig
```
